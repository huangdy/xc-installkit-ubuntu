...
echo INFO: install tomcat7 >> ../install.log
sudo tar -C /usr/share -zxvf apache-tomcat-7.0.57.tar.gz 2>&1 | tee -a ../install.log

echo INFO: sudo mv /usr/share/apache-tomcat-7.0.57 /usr/share/tomcat7 >> ../install.log
...
echo INFO: sudo cp /usr/share/tomcat7/conf/server.xml /usr/share/tomcat7/conf/server.xml.orig >> ../install.log
sudo cp /usr/share/tomcat7/conf/server.xml /usr/share/tomcat7/conf/server.xml.orig 2>&1 | tee -a ../install.log

echo INFO: sudo cp /usr/share/tomcat7/conf/tomcat-users.xml /usr/share/tomcat7/conf/tomcat-users.xml >> ../install.log
sudo cp /usr/share/tomcat7/conf/tomcat-users.xml /usr/share/tomcat7/conf/tomcat-users.xml.orig 2>&1 | tee -a ../install.log

echo INFO: sudo cp conf/server.xml /usr/share/tomcat7/conf >> ../install.log
